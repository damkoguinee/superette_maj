...
//    }
     ...
     * @return array
     */
    public function listeModificationFacturePaginated($startDate, $endDate, int $pageEnCours, int $limit): array
    {
     ...
     * @return array
     */
    public function listeModificationFactureParLieuPaginated($lieu, $startDate, $endDate, int $pageEnCours, int $limit): array
    {
        $endDate = (new \DateTime($endDate))->modify('+1 day');
        $limit = abs($limit);
        $result = [];
